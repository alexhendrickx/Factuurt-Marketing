...
export interface DemoOfferteContent {
  ...
  heading: string
  /** Optionele intro; '' → niet renderen (patroon uit workflow.ts/features.ts). TODO-copywriter. */
  intro: string
  /** Label bij de prijsbibliotheek-lijst (bv. "Kies wat je gedaan hebt"). TODO-copywriter. */
  bibliotheekLabel: string
  /** BTW-toggle: label + de twee opties. tariefStandaard = 21, tariefVerlaagd = 6.
   *  toggleLabel bv. "Renovatie (6% BTW)". TODO-copywriter voor labels; tarieven executor. */
  btwToggle: {
    label: string          // TODO-copywriter
  ...
  /** Knoptekst offerte → werkbon. TODO-copywriter (bv. "Maak er een werkbon van"). */
  flipLabel: string
  ...
  /** Afsluiter-tekst onder de werkbon (bv. "Zo werkt heel Factuurt."). TODO-copywriter. */
  outro: string
  /** Terug-link-label om van werkbon naar offerte te gaan. TODO-copywriter. */
  terugLabel: string
  ...
  /** Waarschuwing bij < minimum selectie (spec: 2–3 regels). TODO-copywriter. */
...
export const demoOfferte: DemoOfferteContent = {
  ...
  intro: '',
  bibliotheekLabel: 'TODO-copywriter',
  btwToggle: {
